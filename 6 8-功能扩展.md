---
created: 2025-12-29T15:54:32 (UTC +08:00)
...
> ## Excerpt
> 本节重点 之前我们已经实现了 AI 零代码应用生成平台的核心功能，用户可以通过简单的对话生成各种类型的前端应用。 本节我们将继续为平台扩展更多功能： 生成应用封面图 下。编程导航教程分享，做您编程学习路上的导航员。
...
本节我们将继续为平台扩展更多功能：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
参考其他的大厂平台，可以直接将网站⁠的实际运行效果作为应用⁠封面图，做到所见即所得；而且应该要自动生成，总不能让管理员手动截图吧？1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
2）使用 [Selenium](https://www.selenium.dev/zh-cn/documentation/) 这样的自动化工具打开一个无头浏览器，访问应用页面并进行截图。qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=
...
4）为了确保图片的持久化存储和快速访⁠问，将压缩后的图片上传到⁠腾讯云 COS 对象存储中，并将访问 URL 保存到数据库的应用表中。nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=
...
1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=WBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=

|评估维度|Selenium|PlaywrightWBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|HtmlUnit|Puppeteer + Node.js|云服务APInShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=|
|---|---|---|---|---|---|
|依赖大小|~50MB|~100MBEVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=|~30MB|~200MB|0MBWBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|
|启动时间|3-5秒|1-2秒EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=|<1秒|2-3秒|网络延迟WBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|
|内存占用|200-500MB|100-300MBnShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=|20-50MB|150-400MB|0MBWBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|
|CPU占用|中等|较低EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=|很低|中等|无F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|
|截图质量|⭐⭐⭐⭐⭐|⭐⭐⭐⭐⭐qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|⭐⭐|⭐⭐⭐⭐⭐|⭐⭐⭐⭐F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|
|JS执行|完整支持|完整支持F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|有限支持|⁠完整支持|完整支持p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|
|Vue/React支持|⭐⭐⭐⭐⭐|⭐⭐⭐⭐⭐p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|⭐⭐|⭐⭐⭐⭐⭐|⭐⭐⭐⭐EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=|
|跨浏览器|Chrome/Firefox/Edge|Chrome/Firefox/Safarip+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|模拟浏览器|仅Chrome系 ⁠|多种选择p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|
|配置复杂度|⭐⭐⭐|⭐⭐⭐⭐qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|⭐⭐⭐⭐⭐|⭐⭐⭐|⭐⭐⭐⭐⭐p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|
|学习成本|⭐⭐⭐⭐|⭐⭐⭐F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|⭐⭐⭐⭐⭐|⭐⭐⭐|⭐⭐⭐⭐⭐F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|
|社区活跃度|⭐⭐⭐⭐⭐|⭐⭐⭐⭐1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=|⭐⭐⭐|⭐⭐⭐⭐⭐|服务商决定qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|
|文档完善度|⭐⭐⭐⭐⭐|⭐⭐⭐⭐F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=|⭐⭐⭐|⭐⭐⭐⭐⭐|服务商决定WBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|
|错误处理|⭐⭐⭐⭐|⭐⭐⭐⭐⭐UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=|⭐⭐⭐|⭐⭐⭐⭐|⭐⭐⭐WBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|
|并发支持|⭐⭐⭐⭐|⭐⭐⭐⭐⭐WBpr9WI72APgOj+DCCZKObs+ofP0VhBHSvqSELGriv0=|⭐⭐⭐|⭐⭐⭐⭐|⭐⭐⭐⭐⭐p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|
|企业采用| 广泛使用|快速增长p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|传统项目|广泛使用|成本敏感1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=|
|总体推荐度|⭐⭐⭐⭐⭐|⭐⭐⭐⭐dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=|⭐⭐|⭐⭐⭐|⭐⭐dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=|

通过对比可以看出，HtmlUnit 虽然轻量，但对 ⁠JS 的支持度有限，这在现代前端应⁠用中是一个致命问题。如果我们选择了它，可能到后面才发现很多应用的封面生成不了，再换技术就得不偿失了。cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
可以说 WebDriver 是 Selenium 与浏览器之间的桥梁，因为不同浏览⁠器（Chrome、Firefox、Safari 等）有⁠不同的内部 API 和控制机制，驱动程序负责将 Selenium 的标准化命令翻译成各个浏览器能理解的具体指令，从而实现跨浏览器的统一自动化控制。F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=
...
![](https://pic.code-nav.cn/course_picture/1608440217629360130/sF0IJpDZkolSJtmG.webp)EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
F+kzRHG1248BgN91hBPqtNxbML3nLzvb0nw4jU7NTyI=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=

|对比项|使用 WebDriverManager|不使用 WebDriverManagercZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=|
|---|---|---|
|配置复杂度|一行代码搞定|需要手动下载、配置路径cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=|
|版本管理|自动匹配最佳版本|手动检查和更新qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|
|跨平台支持|自动适配⁠操作系统|需要为每个平台准备驱动qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|
|CI/CD ⁠友好|开箱即用|需要额外脚本处理UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=|
|维护成本|几乎为零|需要定期更新p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=|
|错误处理|自动重试和降级|需要手动处理各种异常qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=|
...
接下来，我们在 `utils` 包下创建专门用于网页截图的工具类，提供根据 URL 生成截图文件并返回路径的方法。dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=
...
代码如下：cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
此处我选择压缩到 30% 质⁠量，清晰度还不错，⁠而且能大幅减少文件大小，大家可以按需调整。EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
不仅等待 DOM 完全加载，⁠还额外等待 2 秒⁠确保动态内容渲染完成。cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
4）编写单元测试来验证功能：EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
![](https://pic.code-nav.cn/course_picture/1608440217629360130/LrNBBkM65oY3yYYE.webp)cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=

#### 2、保存截图到对象存储

为了让生成的封面图能够持久化⁠存储并快速访问，我⁠们需要将图片上传到腾讯云 COS 对象存储。

首先在 [腾讯云控制台](https://console.cloud.tencent.com/cos/bucket) 创建一个存储桶：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=

![](https://pic.code-nav.cn/course_picture/1608440217629360130/9GR1W9xXbcFacN3g.webp)

注意认真看官方的提示，按需选择参数：

![](https://pic.code-nav.cn/course_picture/1608440217629360130/eYM0iTmvCFv3MQ3f.webp)cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
引入依赖：qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=
...
💡 不同规范下，Manager 层的作用可能不同。比如[《Alibaba Java开发手册》](https://www.codefather.cn/post/1607270508959641601)中的 Manager 层是指 **通用业务处理层**，它有如下特征：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
最后，我们需要在应用部署完成后触发截图生成。在 `AppServiceImpl` 的 `deployApp` 方法中添加相关逻辑：nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=
...
这其实是一种简化写法，单纯为了追求更⁠高的性能。但是在并发截图⁠的场景下，如果复用同一个 WebDriver，可能会导致截图了错误的页面。nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=
...
1）每次创建新实例：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
2）连接池模式，维护一个 W⁠ebDriver ⁠池，按需分配和回收。1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
3）ThreadLocal ⁠模式，每个线程使用⁠同一个 WebDriver：cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
4）使用队列。将要执行的截图任⁠务依次放到队列中，W⁠ebDriver 线程组依次取出任务执行，本质是并行变串行。cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
2）为了提升用户体验，可以给每⁠个应用设置一个默认封⁠面地址，前端可以做降级逻辑，当封面生成失败或加载失败时显示默认图片。EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
除了在线预览和使用生成的应用，用户可⁠能需要下载代码到本地进行二次⁠开发。这样一来，我们的平台不仅是一个在线工具，更是一个真正的开发起点。p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=
...
1）实现文件过滤dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=
...
2）下载压缩包核心方法：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
后端开发完成后，记得先执行 `openapi` 命令，根据接口生成前端请求和数据模型代码。p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=
...
然后提供了调用后端下载代码的函数。由于后端直接返回文件流，我们需要使用原生的 `fetch` API 来获取响应，然后从响应头中提取文件名：p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=
...
效果如图，点击下载按钮后能够成功下载代码压缩包：cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
可以看到后端接口正确设置了响应头：nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=

![](https://pic.code-nav.cn/course_picture/1608440217629360130/AINgYfHfmBohOk4n.webp)

### 扩展思路

1）判断应用是否已经生成了浏⁠览地址，只有生成了⁠地址的应用才允许下载（需要后端配合修改逻辑）。p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=
...
让用户自己选择的话，会增加用户的使用门槛。更好的方案是让 AI 来自动判断，这就是所谓的 **智能路由**。EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=

![image.png](https://pic.code-nav.cn/course_picture/1608440217629360130/5862Jm82YJYke6Qd.webp)

### 方案设计

在实际生产环境中，智能路由本身应该选择 **成本更低、输出更快** 的大模型，因为路由决策是一个相对简单的分类任务，不需要太强的模型。UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=
...
![](https://pic.code-nav.cn/course_picture/1608440217629360130/zFmeayuD3CAFczkl.webp)UzapLzatIvJJsWWs1pRz7879eXluI/+jA6d4qBCHuKE=
...
1）在 `ai` 包下新建 AI 智能路由服务，也是一个 AI Service：nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=
...
2）创建 AI 智能路由服务工厂：EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
这个测试覆盖了 3 种不同复⁠杂度的需求，可以验⁠证智能路由是否能够正确分类。cZq9/nGwbRXl38gxWuOGAJfnulyo9Sx2vt9GhAJuMwQ=
...
![](https://pic.code-nav.cn/course_picture/1608440217629360130/drHuDwY4KUZ14fd6.webp "null")dWCTYpHEFA/xV8BrvOpKRqkO1d88b9Ip8VkvBeLuZho=

改完配置后，从日志中可以看到结构化输出修改了提示词：

![](https://pic.code-nav.cn/course_picture/1608440217629360130/bu0siF75GYF2XYOc.webp "null")

测试结果符合预期，AI 能够⁠根据需求复杂度选择⁠合适的生成方案：qo3wYiJtEuojZDmpW2HRDEwGWUH1DzVFQ47Zs4YmYuk=

![](https://pic.code-nav.cn/course_picture/1608440217629360130/e5BpubP6YyUnsmw5.webp "null")

### 前端开发 - Vibe Coding

为了让用户了解系统选择的生成类型，⁠我们需要在前端展示这个⁠信息。可以在应用详情页的标题右侧和应用详情弹窗内增加生成类型的标签展示。nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=
...
AI 修改了 AppChat⁠Page，应用标题⁠右侧增加了生成类型标签：1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
...
效果如图，对话页面：nShO7+0zZStNyiJdnnoFDwT4JyyptzNsRjyXLsolAAU=

![](https://pic.code-nav.cn/course_picture/1608440217629360130/UimP8ZNFtW21eQyo.webp)

在应用详情弹窗中也会显示生成类型：

![](https://pic.code-nav.cn/course_picture/1608440217629360130/5wyCukbVUFtFF1Ri.webp)p+CfRPZxNEuU7hG8dzfPcN4R10eC9eypGHmTaRf/x7c=

让我们验证一下智能路由的实际效果，创建不同复杂度的应用：

![](https://pic.code-nav.cn/course_picture/1608440217629360130/vPkKHnRxr1n61S6Q.webp)

![](https://pic.code-nav.cn/course_picture/1608440217629360130/RHZQYWHMCNuxz0o6.webp)EVevk6+j/BC/ssKO5aUZF8Rusnkp1o/HghJkPkRChGQ=
...
1vM0bC71h2RCfUkazMGszlP9tIpAZTvdkFrdc8O6/+w=
